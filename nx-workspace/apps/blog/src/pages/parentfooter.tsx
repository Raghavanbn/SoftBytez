        ...
        <div className="border-b-2 border-neutral-200 p-6 dark:border-neutral-500">
          <div className="container mx-auto px-10">
            ...
            <div>
                ...
                <Typography>
                <a className="font-semibold text-white dark:text-white" href="https://softbytez.com/tnc">Terms of use</a> | 
                <a className="font-semibold text-white dark:text-white" href="https://softbytez.com/privacy">Privacy Policy</a> 
                </Typography>
                </p>
            </div>
          </div>
