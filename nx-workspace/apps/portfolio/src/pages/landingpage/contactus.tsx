...
const ContactUsForm = () => {
  ...
  const userId = import.meta.env.VITE_REACT_APP_USERID;
  ...
  const TnCAndPrivacy = () => {
    return (
      <div>
        <Typography>
          I have read and agree to SoftBytez's{' '}
          <u>
            {' '}
    ...
    <div>
      ...
      <div className="mx-6 py-10 items-center justify-center">
        <p className="font-bold text-2xl text-center">
          ...
          <Typography gutterBottom>
            Hours Open Mon - Fri 09:00 – 17:00 IST
          </Typography>
          <Typography gutterBottom>Chennai, TamilNadu, India</Typography>
        </p>
      </div>
      <header>
        <p className="text-prime-color mt-9 text-neutral-400 font-bold text-2xl text-center">
          <Typography variant="h4" gutterBottom>
            <span className="font-righteous">Contact US </span>
          </Typography>
        </p>
      </header>
      <div className="flex flex-col gap-6 p-4">
        ...
        <Alert
          className={isConfirmAlertVisible ? 'visible' : 'invisible'}
          onClose={() => setIsConfirmAlertVisible(false)}
        >
          Thanks for the message. Will reach you shortly!
        </Alert>
        <Alert
          severity="error"
          className={isErrorAlertVisible ? 'visible' : 'invisible'}
